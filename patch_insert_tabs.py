...
# And missing icons for PlayCircle, Headset, ShieldCheck, CheckCircle, CreditCard, Box need to be imported
# Actually some might be imported. We will check it with the compiler.

with open('src/pages/ProductDetails.tsx', 'w') as f:
    f.write(content)
print("Inserted tabs back!")
